...
import java.com.commonfile.Catalog;
import java.com.commonfile.charges_tab;
import java.com.commonfile.parties_tab;
import java.com.commonfile.trnx_confirmed;
import java.com.pomtestcases.Beneficiary_Response;
import com.pomtestcases.EE_Login;
import com.pomtestcases.IPLC_Homepage;
import java.com.pomtestcases.IPLC_RegisterAmendmentLC;
import java.com.pomtestcases.IssueLetterofCredit;
import java.com.pomtestcases.IssueamendmentLC;
import java.com.pomtestcases.RegisterDocument;
...
public class Test_Login {
	...
	void RegisterLC() throws Exception {
		...
		for (int i = 1; i <= rows; i++) 
		{
			...
			registerLC.clickApplicantIdButton(advBankId);
	...
	public void IssueLC(Map<String, String> data) throws Exception 
	{
			...
			registerLC1.clickBeneficiaryIdButton();
			registerLC1.clickApplicantIdButton(advBankId);
